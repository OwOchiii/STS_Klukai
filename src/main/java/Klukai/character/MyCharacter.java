...
import static Klukai.BasicMod.characterPath;
import static Klukai.BasicMod.makeID;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Klukai"); //This should match whatever you have in the CharacterStrings.json file
